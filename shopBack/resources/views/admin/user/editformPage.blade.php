...
<div class="flex justify-center w-full">
    <div class="w-3/4 bg-gray-100 rounded-lg shadow-lg pt-3 pb-3" >
            <form action="{{asset('update-product')}}" method="POST" enctype="multipart/form-data">
            @csrf
                <div class="m-2  flex flex-col justify-center items-center">
                    ...
                    <input value="{{$singleProduct->productName}}" name="pName" class="input-style mt-2" id="name" type="text" placeholder="Product Name">
                    @error('pName')
                ...
                <div class="m-2  flex flex-col justify-center items-center">
                    ...
                    <select name="pBrand"  class="w-3/4 border-2 border-purple-300 rounded-lg hover:border-purple-700 focus:border-purple-700 h-12 text-lg font-normal leading-normal text-gray-700 mt-2" id="brand" type="text" placeholder="Product Name">
                     ...
                     @foreach($brand as $brandName)
                      @if($singleProduct->brandName==$brandName->BrandName)
                ...
                <div class="m-2  flex flex-col justify-center items-center">
                    ...
                    <select name="pCategory" class="w-3/4 border-2 border-purple-300 rounded-lg hover:border-purple-700 focus:border-purple-700 h-12 text-lg font-normal text-gray-700 leading-normal mt-2" id="category" type="text" placeholder="Product Name">
                     ...
                     @if($singleProduct->categoryName==$categoryName->categoryName)
                ...
                <div class="m-2 flex flex-col justify-center items-center">
                    ...
                    <input value="{{$singleProduct->productPrice}}" name="pPrice" class="input-style mt-2" id="price" type="text" placeholder="Product Price">
                    @error('pPrice')
                      <div class="text-red-500 mt-2 text-left w-3/4">{{ $message }}</div>
                     @enderror
                </div>
                ...
                <div class="m-2 flex flex-col justify-center items-center">
                    ...
                    <input value="{{$singleProduct->productQuantity}}" name="pQuantity" class="input-style mt-2" id="quantity" type="text" placeholder="Product quantity">
                    @error('pQuantity')
                      <div class="text-red-500 mt-2 text-left w-3/4">{{ $message }}</div>
                     @enderror
                </div>
                ...
                <div class="m-2 flex flex-col justify-center items-center">
                    ...
                    <input  value="{{$singleProduct->ProductDiscount}}" name="pDiscount" class="input-style mt-2" id="discount" type="text" placeholder="Discount">
                    @error('pDiscount')
                      <div class="text-red-500 mt-2 text-left w-3/4">{{ $message }}</div>
                     @enderror
                </div>
                   ...
                   <div class="w-3/4 flex justify-start items-center">
                        <div class="bg-gray-100 rounded-lg ml-1">
                                <label class="flex flex-col justify-center items-center px-2 py-1 rounded-lg border-2 border-purple-300 hover:border-purple-700">
                                    ...
                                    <input  value="{{$singleProduct->productImageOne}}" name="imageOne" type="file" class="hidden" />
                                </label>
                        </div>
                        <div class="bg-gray-100 rounded-lg ml-3">
                                <label class="flex flex-col justify-center items-center px-2 py-1 rounded-lg border-2 border-purple-300 hover:border-purple-700">
                                    ...
                                    <input  value="{{$singleProduct->productImageTwo}}" name="imageTwo" type="file" class="hidden" />
                                </label>
                        </div>
                        <div class="bg-gray-100 rounded-lg ml-3">
                                <label class="flex flex-col justify-center items-center px-2 py-1 rounded-lg border-2 border-purple-300 hover:border-purple-700">
                                    ...
                                    <input  value="{{$singleProduct->productImageThree}}" name="imageThree" type="file" class="hidden" />
                                </label>
                        </div>
                        <div class="bg-gray-100 rounded-lg ml-3">
                                <label class="flex flex-col justify-center items-center px-2 py-1 rounded-lg border-2 border-purple-300 hover:border-purple-700">
                                    ...
                                    <input  value="{{$singleProduct->productImageFour}}" name="imageFour" type="file" class="hidden" />
                                </label>
                                <!-- {{$singleProduct->productImageFour}} -->
                        </div>
                   </div> 
                    @error('imageOne')
                      <div class="text-red-500 mt-2 text-left w-3/4">{{ $message }}</div>
                ...
                <div class="m-2 flex flex-col justify-center items-center">
                   ...
                   <textarea placeholder="Product descriptiion" class="mt-3 border-2 border-purple-300 hover:border-purple-700 focus:border-purple-700 rounded-lg" name="pDescription" id="description" cols="70" rows="5">
                     @if($singleProduct->productDescription)
                   ...
                   @error('pDescription')
                     ...
                     <input value="{{$singleProduct->id}}" type="hidden" name="updateId"/>        
